...
#define BLOCK 		(7)		//0x0000111 (a block obj)
#define BOMB 		(24)	//0x0011000 (a bomb obj)
#define GRAY_BLOCK 	(1<<0)
#define RED_BLOCK	(1<<1)
#define GREEN_BLOCK (1<<2)
#define BLUE_BOMB	(1<<3)
#define GREEN_BOMB	(1<<4)
...
typedef enum {TITLE, PLAY, END} state;
